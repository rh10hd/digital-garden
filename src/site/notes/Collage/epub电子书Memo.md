...
我今天在在整理电子书的遇到了另外两个关于`<aside>`标签的问题，第一是注释可以跳转，但是不会弹窗，同时注释会直接出现在正文中。第二个问题导出电子书后会出现一个错误提示`“Namespace prefix epub for type on aside is not defined”`。

经过排查后发现，第一个问题是电子书在制作的时候没有使用正确的语法：
...
第二个问题只要在html文件的开头加上`<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops">`即可。
...
最近找书会遇到直排书，我不太习惯，还是更喜欢看横排书，于氏想要给它更改排版，尝试多次后文件都会直接崩溃，无法打开。我就想着可能放进kindle中看会好很多，结果我发现放进kindle的直排书，在koreader的作用下全都变成了横排，简直是惊喜，而且排版也很舒服，不会有别扭的感觉。